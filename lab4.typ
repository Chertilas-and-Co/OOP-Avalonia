...
Либо если мы не можем использовать стандартный механизм наследования, например, если классы определенны с модификатором `sealed` (не могут иметь наследников).
...
Теперь можно собрать проект, выбрав "Сборка --- Собрать решение" в главном меню Visual Studion, или нажатием Ctrl+Shift+B. 
В директории `bin/Debug` будет лежать созданный dll-файл.

Чтобы подключить собранную библиотеку в классов в проект, надо нажать правой кнопкой мыши на "Зависимости" в обозревателе решений и выбрать с помощью диспетчера файлов .dll файл.
