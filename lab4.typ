...
Теперь можно собрать проект, выбрав "Сборка --- Собрать решение" в главном меню Visual Studion, или нажатием Ctrl+Shift+B. В директории `bin/Debug` будет лежать созданный dll-файл.
